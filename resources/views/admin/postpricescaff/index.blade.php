...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Прайс строительных лесов</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            {{-- <a href="{{ route('pricescaff.create') }}" class="btn btn-primary mb-3">Добавить прайс</a> --}}
                            @if (count($pricescaff))
                                        ...
                                        @foreach($pricescaff -> reverse() as $post)
                                            <tr>
                                                ...
                                                <td style="display: flex;">
                                                    <a href="{{ route('pricescaff.edit',  $post->id) }}" class="btn btn-info btn-sm float-left mr-1">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </a>

                                                    <form action="{{ route('pricescaff.destroy', $post->id) }}" method="POST">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}
                            ...
                            @else
                                <p>Прайс строительных лесов еще не добавлен...</p>
                            @endif
                        </div>
                        <!-- /.card-body -->
