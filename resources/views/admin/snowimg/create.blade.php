...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Добавление медиа в галерею уборка снега с крыш</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <!-- form start -->
                <form role="form" method="post" action="{{ route('postssnow.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('postssnow.index') }}" type="button" class="btn btn-success">Назад</a>
