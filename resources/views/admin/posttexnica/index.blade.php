            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('poststexnica.create') }}" class="btn btn-primary mb-3">Добавить файл</a>
                            @if (count($texnica))
                                        ...
                                        @foreach($texnica as $post)
                                            <tr>
                                                ...
                                                <td style="display: flex;">
                                                    <form action="{{ route('poststexnica.destroy', $post->id) }}" method="post" class="float-left">
                                                        @csrf
                                                        @method('DELETE')
