...
class PostTractor extends Model
{
    use HasFactory;
    ...
    public static function uploadImage(Request $request, $image = null)
    {
        if ($request->hasFile('img')) {
            ...
            $urlNode->addChild('loc', url('https://арендавысоты.рф/галерея-минитрактор'));
            ...
            $imageNode->addChild('image:title', 'минитрактор', 'http://www.google.com/schemas/sitemap-image/1.1');
