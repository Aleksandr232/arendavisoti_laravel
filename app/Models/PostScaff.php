...
class PostScaff extends Model
{
    ...
    protected $fillable = ['square', 'objects', 'img', 'appointment'];
    ...
    public static function uploadImage(Request $request, $image = null)
    {
        if ($request->hasFile('img')) {
            ...
            $urlNode->addChild('loc', url('https://арендавысоты.рф/галерея-строительных-лесов'));
            ...
            $imageNode->addChild('image:title', 'строительные леса', 'http://www.google.com/schemas/sitemap-image/1.1');
