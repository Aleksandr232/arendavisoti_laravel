...
class PostImgTours extends Model
{
    ...
    protected $fillable = ['title', 'content', 'img', 'height'];
    ...
    public static function uploadImage(Request $request, $image = null)
    {
        if ($request->hasFile('img')) {
            ...
            $urlNode->addChild('loc', url('https://арендавысоты.рф/галерея-вышек-тур'));
            ...
            $imageNode->addChild('image:title', 'вышки-туры', 'http://www.google.com/schemas/sitemap-image/1.1');
